...
const slsVersion = require('./../../package.json').version;
...
module.exports.logError = (e) => {
  try {
    ...
    if (e.name !== 'ServerlessError') {
      ...
      consoleLog(chalk.red('     Make sure to include this information in your report:'));
      consoleLog(chalk.red(' '));
      consoleLog(chalk.red(`     Node: ${process.version} Serverless: ${slsVersion}`));
    }
